...
|---------|--------|----------|
| manifest | targetSdk >= 36 (v0.9.79+), debuggable, testOnly (reads from `<application>` element since v0.9.80), cleartext, missing exported, FGS types, geofencing foreground service (v0.9.65+) | critical/error/warning |
